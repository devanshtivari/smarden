...
export default function Groups() {
    ...
    const { GetGauze, gauzes, AddGauze, devices, getAllDevices, DeleteGauze, EditGauze } = context;


    const [credentials, setCredentials] = useState({ switch_name: "", minimum_value: "", maximum_value: "" })
    const [selectId, setSelectId] = useState({ device_id: "" })
    const [switchId, setSwitchId] = useState({ id: "" })

    const initialState = { switch_name: "", minimum_value: "", maximum_value: "" }
    ...
    gauzes ? console.log(gauzes) : console.log('nh');
    ...
    const handleSubmit = (e) => {
        ...
        console.log(selectId.device_id);
                        ...
                        <div className="modal-body">
                                ...
                                <div class="form-group">
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="exampleInputEmail1">Gauge Name</label>
                            ...
                            <div className="col-md-8">
                                <div class="card card-secondary ">
                                    <div class="card-header">
                                        <h3 class="card-title">List of Gauges Created</h3>
                                    ...
                                    <div class="card-body">
                                        {gauzes ? gauzes.map((e) => {
                                            return <div className="card" key={e.id}>
                                                ...
                                                <div className="ButtonDetail contents">
                                                    <div className='flexDivs'> Max Value:  </div>
                            ...
                            <div className="col-md-4">
                                <div className="card card-info">
                                    <div className="card-header">
                                        <h3 className="card-title">Create New Gauges </h3>
                                    </div>
