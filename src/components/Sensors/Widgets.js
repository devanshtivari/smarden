...
export default function Groups() {
    ...
    const { GetWidget, widgets, AddWidget, devices, getAllDevices, DeleteWidget, EditWidget } = context;


    const [credentials, setCredentials] = useState({ switch_name: "", unit: "" })
    ...
    const initialState = { switch_name: "", unit: "" }
    ...
    widgets ? console.log(widgets) : console.log('nh');
                        ...
                        <div className="modal-body">
                                ...
                                <div class="form-group">
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="exampleInputEmail1">Widget Name</label>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" id="exampleInputEmail1" placeholder="" name='unit' value={credentials.unit} onChange={handleChange} required />
                                            </div>
                                </div>
                            ...
                            <div className="col-md-8">
                                <div class="card card-secondary ">
                                    <div class="card-header">
                                        <h3 class="card-title">List of Widget Created</h3>
